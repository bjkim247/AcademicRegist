...
public class StudentDAO {
	public void setStudentRegistr(StudentVO svo) {
		String sql = "insert into student values  (student_seq.nextval, ?, ?, ?, ?, ?, ?, ?, ?, ?, sysdate)" ; 
			...
			// 학생 정보 수정 
				...
				public boolean getStudentIdOverlap(String idOverlap) {
					...
					PreparedStatement pstmt = null;
					ResultSet rs = null;
					boolean idOverlapResult = false; //중복된 아이디가 있다.
				...
				public boolean getStudentLogin(String id, String pw) throws Exception { 
							String sql = "select * from student where sd_id = ? and sd_passwd = ?"; Connection con = null; 
							PreparedStatement pstmt = null; 
							ResultSet rs = null; 
					...
					public void getStudent(String id, String pw) {
						...
						try {
							...
							if(rs.next()) {
								...
								System.out.println(sVo.getNo() + "\t" + sVo.getSd_num() +  
								"\t" + sVo.getSd_name() + "\t" + sVo.getSd_id() + "\t" + sVo.getSd_passwd() + "\t" +  sVo.getS_num() + "\t\t" + sVo.getSd_birthday() + "\t" + sVo.getSd_phone() + "\t" +  sVo.getSd_address() + "\t\t" + sVo.getSd_email() + "\t\t" + sVo.getSd_date()); } 
								} catch (SQLException e) { 
								System.out.println("e=[" + e + "]"); 
								} catch (Exception e) { 
								System.out.println("e=[" + e + "]"); 
